...
#создаем список lowcost_list c наименованиями товаров стоимостью менее 13000
lowcost_list = []
for item in log_list:
    if int(item['item_cost']) < 13000:
        title = item['item']
        #cost = item['item_cost']
        lowcost_list.append(title)
#print(lowcost_list)
#удаляем повторы из списка lowcost_list:
lowcost_list_final = list(set(lowcost_list))
print('Список товаров стоимостью менее 13000:')
for item in lowcost_list_final: 
    print(item)